...
class ClientTask(models.Model):
    ...
    partner_attachment_file = models.CharField(max_length=500,null=True, blank=True)
    manager_attachment_file = models.CharField(max_length=500,null=True, blank=True)
    auditor_attachment_file = models.CharField(max_length=500,null=True, blank=True)
    article_attachment_file = models.CharField(max_length=500,null=True, blank=True)
